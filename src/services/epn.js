    ...
    const dps = {
        infDps: {
            ...
            prestador: {
                ...
                // E0121 / E0128: quando o prestador é o emitente (tpEmit=1),
                // NÃO se envia nome NEM endereço — a SEFAZ usa o cadastro pelo
                // CNPJ. Esses campos só vão quando o emitente é o tomador
                // (tpEmit=2) ou intermediário (tpEmit=3).
                regimeTributario: {
